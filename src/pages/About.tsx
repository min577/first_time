  ...
  return (
    <div className="about">
      ...
      <section className="about-section" aria-labelledby="about-bg">
        ...
        <p>
          <span>회식 문화 축소로 소주의 사회적 역할이 줄었지만, 인생의 '처음'은 사라지지 않았다.</span>
          <span>2030의 처음은 몰라서 무섭고, 3049의 처음은 모른다고 말할 수 없다.</span>
        </p>
      </section>
      ...
      <section className="about-section" aria-labelledby="about-idea">
        ...
        <p>
          <span>병뚜껑을 따면 열리는 수업, 처음학개론.</span>
          <span>뚜껑 안 QR(한정판은 화면에 도장처럼 찍는 방식)로 입장한다.</span>
          <span>고백은 병 하나당 한 번뿐인 응모이고, 가장 많은 잔을 받은 처음이 다음 주의 라벨이 된다.</span>
        </p>
      ...
      <section className="about-section" aria-labelledby="about-effect">
        ...
        <p>
          <span>오늘의 후배가 내일의 선배가 되는 순환 구조다.</span>
          <span>'처음'이라는 하나의 언어로 3049와 2030을 함께 묶고, 절주 가이드를 내장해 책임 있는 음주 문화까지 설계한다.</span>
        </p>
      </section>
